...
def test_endpoints():
    print("Testing Humidifier Turn Off...")
    status, resp = post_json(f"{BASE_URL}/control/humidifier", {"command": "turnOff"})
    print(f"Status: {status}")
    print(f"Response: {resp}")

    print("Testing Air Conditioner Turn Off...")
    status, resp = post_json(f"{BASE_URL}/control/air-conditioner", {"command": "turnOff"})
    print(f"Status: {status}")
    print(f"Response: {resp}")

...
def main():
    ...
    try:
        ...
        # Note: 'turnOn' is the standard command, parameter 'default' is usually fine for IR devices to use last state
        status, resp = post_json(f"{BASE_URL}/control/air-conditioner", {"command": "turnOn"})
